...
bool operator==(const clan::ColorBlendAttachmentState &lhs, const clan::ColorBlendAttachmentState &rhs)
{
...
bool operator!=(const clan::StencilOpState &lhs, const clan::StencilOpState &rhs)
{
...
bool operator!=(const clan::VertexInputState &lhs, const clan::VertexInputState &rhs)
{
	return lhs.attributes != rhs.attributes || lhs.bindings != rhs.bindings;
}

bool operator!=(const clan::InputAssemblyState &lhs, const clan::InputAssemblyState &rhs)
{
	return std::tie(lhs.primitive_restart_enable, lhs.topology) != std::tie(rhs.primitive_restart_enable, rhs.topology);
}

bool operator!=(const clan::RasterizationState &lhs, const clan::RasterizationState &rhs)
{
...
bool operator!=(const clan::ViewportState &lhs, const clan::ViewportState &rhs)
{
	return lhs.viewport_count != rhs.viewport_count || lhs.scissor_count != rhs.scissor_count;
}

bool operator!=(const clan::MultisampleState &lhs, const clan::MultisampleState &rhs)
{
...
bool operator!=(const clan::DepthStencilState &lhs, const clan::DepthStencilState &rhs)
{
...
bool operator!=(const clan::ColorBlendState &lhs, const clan::ColorBlendState &rhs)
{
	return std::tie(lhs.logic_op, lhs.logic_op_enable) != std::tie(rhs.logic_op, rhs.logic_op_enable) ||
	       ...
	       !std::equal(lhs.attachments.begin(), lhs.attachments.end(), rhs.attachments.begin(),
	                   [](const clan::ColorBlendAttachmentState &lhs, const clan::ColorBlendAttachmentState &rhs) {
		                   return lhs == rhs;
	                   });
}
