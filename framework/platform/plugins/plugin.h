...
namespace clan
{
     ...
     *        and which will not without directly specifying an exclusion or inclusion list. Tags are struct types so that
     *        they can be used in the tagging system (See plugin implementation).
     * 
    ...
    /**
     * @brief Associate how plugins can interact with each other. This interoperability is decided by comparing tags of different plugins.
     *        The plugins inclusion and exclusion lists are populated by this function
     * 
    ...
    /**
     * @brief Hooks are points in the project that an plugin can subscribe too.
     *        These can be expanded on to implement more behaviour in the future
     * 
    ...
    public:
        ...
        /**
         * @brief the process of activating and initializing an plugin
         * 
         * @param platform the platform
         * @param parser The parser used to check if the plugins flags are present
         * @param force_activation Force a plugin to be activated
        ...
        /**
         * @brief Handle when an app errors
         * 
         * @param app_id The ID of the app
         */
    ...
    // The following provides helper functions for filtering containers of plugins

    namespace plugins
    {
        /**
         * @brief Get all plugins with tags, Plugin must include one or more tags
         * 
