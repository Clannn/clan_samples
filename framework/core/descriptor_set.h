...
namespace clan
{
    ...
    /**
     * @brief A descriptor set handle allocated from a DescriptorPool.
    ...
    public:
         ...
         *        Optionally prepares a new set of buffer infos and image infos
         * 
         ...
         */
        void update(const std::vector<uint32_t>& binding_to_update = {});
