...
namespace clan
{
        ...
        entry_point{entry_point}
    {
        ...
        if (entry_point.empty()){
            throw VulkanException{VK_ERROR_INITIALIZATION_FAILED, "shader module without entry point"};
        }
        ...
        if (source.empty()){
            throw VulkanException{VK_ERROR_INITIALIZATION_FAILED, "shader source file is empty"};
        }
        ...
        if (!glsl_compiler.compile_to_spirv(stage, convert_to_bytes(glsl_final_source), entry_point, shader_variant, spirv, info_log)){
            ...
            LOGE("{}", info_log);
            throw VulkanException{VK_ERROR_INITIALIZATION_FAILED, "Compile shader failed"};
        }
        ...
        if (!spirv_reflection.reflect_shader_resources(stage, spirv, resources, shader_variant)){
            throw VulkanException{VK_ERROR_INITIALIZATION_FAILED, "could not reflect shader resources from spirv source code"};
        }
