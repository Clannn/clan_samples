...
namespace clan
{
    ...
    void CommandBuffer::bind_vertex_buffers(uint32_t first_binding, const std::vector<std::reference_wrapper<const Buffer>> &buffers, const std::vector<VkDeviceSize> &offsets)
    {
    ...
    void CommandBuffer::copy_buffer_to_image(const Buffer &buffer, const Image &image, const std::vector<VkBufferImageCopy> &regions)
    {
    ...
    void CommandBuffer::copy_image_to_buffer(const Image &image, VkImageLayout image_layout, const Buffer &buffer, const std::vector<VkBufferImageCopy> &regions)
    {
    ...
    void CommandBuffer::buffer_memory_barrier(const Buffer &buffer, VkDeviceSize offset, VkDeviceSize size, const BufferMemoryBarrier &memory_barrier)
    {
    ...
    RenderPass &CommandBuffer::get_render_pass(const RenderTarget &render_target, const std::vector<LoadStoreInfo> &load_store_infos, const std::vector<std::unique_ptr<Subpass>> &subpasses)
    {
        // Create render pass
