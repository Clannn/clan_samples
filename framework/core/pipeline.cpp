...
namespace clan
{
        ...
        Pipeline{device}
    {
        ...
        if (result != VK_SUCCESS){
            throw VulkanException{result, "Cannot create Shader Module in compute pipeline"};
        }
        ...
        Pipeline{device}
    {
        ...
        for (const ShaderModule *shader_module : pipeline_state.get_pipeline_layout().get_shader_modules()){
            ...
            if (result != VK_SUCCESS){
                throw VulkanException{result, "Cannot create Shader Module in graphic pipeline"};
            }
