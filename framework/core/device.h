...
namespace clan
{
    ...
    public:
        ...
        /**
         * @brief returns the version of the driver of the current physical device
         */
        DriverVersion get_driver_version() const;

        /**
         * @brief Whether an image format is supported by the GPU
         */
        ...
        */
        void copy_buffer(Buffer &src, Buffer &dst, VkQueue queue, VkBufferCopy *copy_region = nullptr);
